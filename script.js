...
const translations = {
  en: {
    ...
    uploadEvidence: '📤 Save and Upload',
  ...
  km: {
    ...
    additionalNotes: 'កំណត់ចំណាំបន្ថែម (ស្ម័គ្រច្ឆន្ទ):',
    uploadEvidence: '📤 រក្សាទុក និងបង្កើន',
  ...
  zh: {
    ...
    url: '网址:',
    selectFile: '选择文件:',
    additionalNotes: '其他说明(可选):',
    uploadEvidence: '📤 保存并上传',
    workersList: '相关工人(可选):',
    selectWorker: '选择工人...',
    workerName: '名称',
    workerSex: '性别',
